...
def get_args():
    ...
    parser.add_argument("--gceq", default=0.7, type=float)
    ...
    parser.add_argument("--nnn", type=int, default=0)
    ...
    parser.add_argument("--cross_id", type=int, default=0)
    parser.add_argument("--weight_id", default=1.0, type=float)
